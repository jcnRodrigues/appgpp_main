...
"[project]/src/app/api/funcao/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    const canAccess = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$access$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hasModuleAccessForRequest"])(request, 'FUNCOES');
    if (!canAccess) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        message: 'Sem permissao para acessar funcoes'
    }, {
        status: 403
    });
    try {
        ...
        const funcoes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$Funcao$2e$service$2f$funcao$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getFuncoes"])({
            skip,
            take,
            nome,
            centroId: centroId || undefined
        });
        const total = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$Funcao$2e$service$2f$funcao$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["contarFuncoes"])(nome, centroId || undefined);
...
async function POST(request) {
    ...
    if (!canAccess || !canCreate) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        message: 'Sem permissao para criar funcao'
    }, {
        status: 403
    });
    try {
        ...
        const funcao = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$Funcao$2e$service$2f$funcao$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["criarFuncao"])({
            nomeFuncao: dados.nomeFuncao
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(funcao, {
            status: 201
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6207f26c._.js.map