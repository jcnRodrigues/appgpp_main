...
"[project]/src/app/api/patrimonio/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        const canAccess = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$access$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hasModuleAccessForRequest"])(request, 'PATRIMONIO');
        if (!canAccess) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Sem permissao para acessar patrimonio'
            }, {
                status: 403
            });
        }
        ...
        if (!canUpdate) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Sem permissao para alterar patrimonio'
            }, {
                status: 403
            });
        }
        const { id } = await params;
        const patrimonio = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$Patrimonio$2e$services$2f$patrimonio$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getPatrimonioCardById"])(id);
        if (!patrimonio) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(patrimonio);
    } catch (error) {
...
async function PUT(request, { params }) {
    try {
        ...
        if (typeof dados.dataEntPat !== 'undefined') updateData.dataEntPat = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$date$2d$input$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseNullableDateInput"])(dados.dataEntPat);
        if (typeof dados.dataSaiPat !== 'undefined') updateData.dataSaiPat = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$date$2d$input$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseNullableDateInput"])(dados.dataSaiPat);
        ...
        if (typeof dados.valorPat !== 'undefined') {
            ...
            if (Number.isNaN(v)) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const patrimonio = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$Patrimonio$2e$services$2f$patrimonio$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["atualizarPatrimonio"])(id, updateData);
        if (patrimonio.idPat_StatusPat) {
            const status = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbStatusPat.findUnique({
                where: {
                    idStatusPat: patrimonio.idPat_StatusPat
                }
            });
            const isDevolucao = normalizar(status?.descricaoStatPat).includes('devolu');
            if (isDevolucao) {
                const dataDevolucao = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$date$2d$input$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseNullableDateInput"])(dados.dataDevPat) || (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$date$2d$input$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseNullableDateInput"])(dados.dataSaiPat) || new Date();
                const devolucaoAberta = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbDevolucao.findFirst({
                    where: {
                ...
                if (devolucaoAberta) {
                    await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbDevolucao.update({
                        ...
                        data: {
                            ...
                            dataSaidaFornecedor: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$date$2d$input$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseNullableDateInput"])(dados.dataSaidaFornecedor),
                            dataChegadaFornecedor: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$date$2d$input$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseNullableDateInput"])(dados.dataChegadaFornecedor),
                            dataFimDevolucao: null
                        }
                    });
                } else {
                    await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbDevolucao.create({
                        data: {
                            idPatrimonio: patrimonio.idPat,
                            dataInicioDevolucao: dataDevolucao,
                            motivoDevolucao: typeof dados.motivoDevolucao === 'string' ? dados.motivoDevolucao.trim() || null : null,
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbDevolucao.updateMany({
                    where: {
                        idPatrimonio: patrimonio.idPat,
                        dataFimDevolucao: null
                    },
...
//# sourceMappingURL=%5Broot-of-the-server%5D__79567805._.js.map