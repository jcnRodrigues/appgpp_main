...
async function POST(request, { params }) {
    try {
        ...
        if (!body?.idCustoDestino) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Centro de custo de destino é obrigatório'
            }, {
                status: 400
            });
        }
        ...
        if (!allowAll && centros.length > 0) {
            ...
            if (!centros.includes(centroAtual) || !centros.includes(body.idCustoDestino)) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    message: 'Sem permissão para transferir entre estes centros de custo'
                }, {
                    status: 403
                });
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7fffe1bf._.js.map