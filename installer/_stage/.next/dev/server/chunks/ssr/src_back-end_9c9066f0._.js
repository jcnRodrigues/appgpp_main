...
function MedicaoCCustoForm({ centros }) {
    ...
    const gerarRelatorioMedicao = ()=>{
        if (!resultado) return;
        const linhas = [];
        linhas.push('RELATÓRIO DE MEDIÇÃO');
        ...
        linhas.push(`OK;${resultado.resumo.ok};${formatarMoeda(resumoInconsistencias?.valorOk || 0)}`);
        linhas.push(`Valor divergente;${resultado.resumo.divergentes};${formatarMoeda(resumoInconsistencias?.valorDivergentes || 0)}`);
        linhas.push(`Não encontrado;${resultado.resumo.naoEncontrados};${formatarMoeda(resumoInconsistencias?.valorNaoEncontrados || 0)}`);
        linhas.push(`Linha inválida;${resultado.resumo.invalidos};${formatarMoeda(resumoInconsistencias?.valorInvalidos || 0)}`);
        linhas.push(`Não informados no arquivo;${resultado.naoInformados.length};${formatarMoeda(resumoInconsistencias?.valorNaoInformados || 0)}`);
        linhas.push(`Total de linhas;${resultado.resumo.totalLinhas};${formatarMoeda(resumoInconsistencias?.valorTotalLinhas || 0)}`);
        linhas.push('');
        linhas.push('DETALHE DA CONFERÊNCIA');
        linhas.push('Linha;ID Patrimônio;Valor Informado;Valor Sistema;Status;Mensagem');
        ...
        linhas.push('');
        linhas.push('PATRIMÔNIOS NÃO INFORMADOS');
        linhas.push('ID Patrimônio;Descrição;Valor Sistema;Situação;Detalhe');
        for (const item of resultado.naoInformados){
            linhas.push([
                escaparCsv(item.idPat),
                escaparCsv(item.descricaoPat || 'Sem descrição'),
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Button"], {
                                type: "button",
                                onClick: gerarRelatorioMedicao,
                                disabled: !resultado || loading,
                                children: "Gerar Relatório da Medição"
                            }, void 0, false, {
                                fileName: "[project]/src/back-end/components/MedicaoCCustoForm/MedicaoCCustoForm.tsx",
                                lineNumber: 187,
                                columnNumber: 21
...
//# sourceMappingURL=src_back-end_9c9066f0._.js.map