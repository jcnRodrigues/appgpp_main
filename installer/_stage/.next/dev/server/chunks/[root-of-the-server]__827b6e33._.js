...
"[project]/src/back-end/service/CentroCusto.service/centrocusto.service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function listarCentrosCusto(filtro) {
...
async function contarCentrosCusto(filtro) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbCCusto.count({
        where: buildCentroCustoWhere(filtro)
    });
}
async function getCentroCustoById(id) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbCCusto.findUnique({
        where: {
            idCCusto: id
        },
        include: {
...
async function criarCentroCusto(dados) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbCCusto.create({
        data: {
...
async function atualizarCentroCusto(id, dados) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbCCusto.update({
        where: {
            idCCusto: id
        },
        data: dados
...
async function deletarCentroCusto(id) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbCCusto.delete({
        where: {
            idCCusto: id
        }
    });
...
async function listarEmpresas() {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbEmpresa.findMany({
        orderBy: {
            fantasiaEmpresa: 'asc'
        }
    });
...
"[project]/src/back-end/service/Funcao.service/funcao.service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"40018b07d5f8521d072a5415d65b34b178e722c923":"criarFuncao","406820e2992d436c1fcb6a319d622f8a9e2ffdaca8":"getFuncoes","4088e1ad3292c080e2a28f7eb36b5919d97b916d4b":"deletarFuncao","408b0795c0eb986c43328174653a9b555dcf7c893a":"getFuncaoById","60371efd80490be7f945e933c1a3dcc752583213c1":"atualizarFuncao","60e44253dd9559b536064dae62eebbe1ef1a150def":"contarFuncoes"},"",""] */ __turbopack_context__.s([
    "atualizarFuncao",
    ()=>atualizarFuncao,
    "contarFuncoes",
    ()=>contarFuncoes,
...
async function getFuncoes(paginacao) {
    ...
    if (!nome) {
        const funcoes = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbFuncao.findMany({
            where: whereCentro,
            skip,
            take,
            orderBy: {
    ...
    const todasFuncoes = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbFuncao.findMany({
        where: whereCentro,
        orderBy: {
            nomeFuncao: 'asc'
        }
    });
    const filtradas = todasFuncoes.filter((funcao)=>normalizarTexto(funcao.nomeFuncao).includes(filtroNormalizado));
    const paginadas = filtradas.slice(skip, skip + take);
    return await adicionarQuantidadeFuncionarios(paginadas, centroId);
}
async function contarFuncoes(nome, centroId) {
    ...
    if (!nomeFiltro) {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbFuncao.count({
            where: whereCentro
        });
    }
    ...
    return todasFuncoes.filter((funcao)=>normalizarTexto(funcao.nomeFuncao).includes(filtroNormalizado)).length;
}
async function adicionarQuantidadeFuncionarios(funcoes, centroId) {
    const idsFuncoes = funcoes.map((funcao)=>funcao.idFuncao);
    if (idsFuncoes.length === 0) return [];
    const funcionariosAgrupados = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbFuncionario.groupBy({
        by: [
            'idFuncaoFun'
        ],
        where: {
    ...
    const contagemPorFuncao = new Map(funcionariosAgrupados.filter((item)=>item.idFuncaoFun).map((item)=>[
            item.idFuncaoFun,
            item._count.idF
        ]));
...
async function getFuncaoById(idFuncao) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbFuncao.findUnique({
        where: {
            idFuncao
        },
        include: {
...
async function criarFuncao(dados) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbFuncao.create({
        data: {
            nomeFuncao: dados.nomeFuncao
        }
    });
}
async function atualizarFuncao(idFuncao, dados) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbFuncao.update({
        where: {
            idFuncao
        },
        data: dados
...
async function deletarFuncao(idFuncao) {
    // Verifica se ha funcionarios com essa funcao
    const funcionariosComFuncao = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbFuncionario.count({
        where: {
            idFuncaoFun: idFuncao
        }
    });
    ...
    return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbFuncao.delete({
        where: {
            idFuncao
        }
    });
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(getFuncoes, "406820e2992d436c1fcb6a319d622f8a9e2ffdaca8", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(contarFuncoes, "60e44253dd9559b536064dae62eebbe1ef1a150def", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(getFuncaoById, "408b0795c0eb986c43328174653a9b555dcf7c893a", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(criarFuncao, "40018b07d5f8521d072a5415d65b34b178e722c923", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(atualizarFuncao, "60371efd80490be7f945e933c1a3dcc752583213c1", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(deletarFuncao, "4088e1ad3292c080e2a28f7eb36b5919d97b916d4b", null);
}),
"[project]/src/back-end/service/Licenca.service/licenca.service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"403e519bd6b87a0105855339184524aa8486a48b8f":"listarLicencas","403e94b537b3cbebec732f5cfe544cd941cc74b7e6":"deletarLicenca","40574bf3ecadf44ec21ddc85d4088259053dd41c6a":"criarLicenca","4077edf7611b4cb02e375a5ede4f2227b00f859695":"getLicencaById","40a1c9b78cf5cf190b83f7aee7edaa7d4a784a1a6d":"contarLicencas","60f41d06a3cdf24c651de2f296403d601f875393bd":"atualizarLicenca"},"",""] */ __turbopack_context__.s([
    "atualizarLicenca",
    ()=>atualizarLicenca,
    "contarLicencas",
    ()=>contarLicencas,
...
async function listarLicencas(filtro) {
    const descricao = filtro?.descricao?.trim();
    const skip = filtro?.skip ?? 0;
    const take = filtro?.take ?? 10;
    if (!descricao) {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbLicenca.findMany({
            include: {
                _count: {
                    select: {
    ...
    const todasLicencas = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbLicenca.findMany({
        include: {
            _count: {
                select: {
                    tbHasLicencaFuncionario: true
    ...
    const filtradas = todasLicencas.filter((licenca)=>normalizarTexto(licenca.descricaoLic).includes(filtroNormalizado));
    return filtradas.slice(skip, skip + take);
}
async function contarLicencas(descricao) {
    const descricaoFiltro = descricao?.trim();
    if (!descricaoFiltro) {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbLicenca.count();
    }
    ...
    return todasLicencas.filter((licenca)=>normalizarTexto(licenca.descricaoLic).includes(filtroNormalizado)).length;
}
async function criarLicenca(dados) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbLicenca.create({
        data: {
...
async function getLicencaById(idLic) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbLicenca.findUnique({
        where: {
            idLic
        },
        include: {
...
async function atualizarLicenca(idLic, dados) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbLicenca.update({
        where: {
            idLic
        },
        data: dados,
...
async function deletarLicenca(idLic) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbLicenca.delete({
        where: {
            idLic
        }
    });
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(listarLicencas, "403e519bd6b87a0105855339184524aa8486a48b8f", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(contarLicencas, "40a1c9b78cf5cf190b83f7aee7edaa7d4a784a1a6d", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(criarLicenca, "40574bf3ecadf44ec21ddc85d4088259053dd41c6a", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(getLicencaById, "4077edf7611b4cb02e375a5ede4f2227b00f859695", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(atualizarLicenca, "60f41d06a3cdf24c651de2f296403d601f875393bd", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(deletarLicenca, "403e94b537b3cbebec732f5cfe544cd941cc74b7e6", null);
}),
"[project]/src/back-end/service/unifi.service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function getUnifiConfig() {
    try {
        const config = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbUnifiConfig.findFirst({
            where: {
                isActive: true
            },
            orderBy: {
...
async function saveUnifiConfig(data) {
    try {
        const existingConfig = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbUnifiConfig.findFirst({
            where: {
                isActive: true
            }
        });
        if (existingConfig) {
            ...
            return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbUnifiConfig.update({
                where: {
            ...
            return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbUnifiConfig.create({
                data: {
                    ...data
                }
            });
...
async function deleteUnifiConfig() {
    try {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbUnifiConfig.deleteMany({
            where: {
                isActive: true
            }
        });
...
async function getAllUnifiConfigs() {
    try {
        const configs = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbUnifiConfig.findMany({
            orderBy: {
                createdAt: 'desc'
            }
        });
...
async function deactivateUnifiConfig(id) {
    try {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbUnifiConfig.update({
            where: {
                id
...
async function activateUnifiConfig(id) {
    try {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].$transaction(async (tx)=>{
...
"[project]/src/app/api/delete-authorize/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$CentroCusto$2e$service$2f$centrocusto$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/back-end/service/CentroCusto.service/centrocusto.service.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$Funcao$2e$service$2f$funcao$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/back-end/service/Funcao.service/funcao.service.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$Licenca$2e$service$2f$licenca$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/back-end/service/Licenca.service/licenca.service.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$unifi$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/back-end/service/unifi.service.ts [app-route] (ecmascript)");
;
;
;
;
...
async function executeDelete(resource, id) {
    switch(resource){
        case 'funcionario':
            if (!id) throw new Error('ID obrigatorio para funcionario');
            await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbFuncionario.delete({
                where: {
                    idF: id
                }
            });
        ...
        case 'patrimonio':
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbPatrimonio.delete({
                where: {
                    idP: id
                }
            });
        ...
        case 'cadastro':
            ...
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$Cadastro$2e$service$2f$cadastro$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deletarAlocacao"])(id);
            return;
        case 'ccusto':
            if (!id) throw new Error('ID obrigatorio para centro de custo');
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$CentroCusto$2e$service$2f$centrocusto$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deletarCentroCusto"])(id);
            return;
        case 'funcao':
            if (!id) throw new Error('ID obrigatorio para funcao');
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$Funcao$2e$service$2f$funcao$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deletarFuncao"])(id);
            return;
        case 'licenca':
            if (!id) throw new Error('ID obrigatorio para licenca');
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$Licenca$2e$service$2f$licenca$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deletarLicenca"])(id);
            return;
        case 'usuario_acesso':
            if (!id) throw new Error('ID obrigatorio para usuario de acesso');
            await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbUser.delete({
                where: {
                    id
                }
            });
            return;
        case 'unifi_config':
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$unifi$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteUnifiConfig"])();
            return;
        default:
...
async function POST(request) {
    try {
        ...
        const autorizador = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbUser.findFirst({
            where: {
                emailUser: email,
                authTypeUser: 'LOCAL',
                statusUser: 'ATIVO'
        ...
        if (!autorizador?.senhaUser) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Usuario autorizador invalido'
            }, {
                status: 401
            });
        }
        ...
        if (!formularios.includes('DELETE_ANY')) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Usuario sem permissao de exclusao'
            }, {
                status: 403
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__827b6e33._.js.map