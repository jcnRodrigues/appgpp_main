...
;
;
const prismaClient = __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"];
...
const FORMULARIOS_TODOS = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$permissions$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["buildAdminPermissions"])();
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$providers$2f$credentials$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])({
            ...
            async authorize (credentials) {
                ...
                return {
                    ...
                    authType: "LOCAL",
                    formularios: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$permissions$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizePermissions"])(acesso.formulariosUser),
                    centros: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$permissions$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizePermissions"])(acesso.centrosUser),
        ...
        async jwt ({ token, user, account }) {
            ...
            if (user?.formularios) {
                ...
                if (acesso) {
                    ...
                    token.formularios = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$permissions$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizePermissions"])(acesso.formulariosUser);
                    token.centros = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$permissions$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizePermissions"])(acesso.centrosUser);
...
"[project]/src/app/api/ccusto/medicao/bm/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const prismaClient = __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"];
async function resolverTbUserIdDaSessao(session) {
    ...
    const porIdDireto = sessaoId ? await prismaClient.tbUser.findFirst({
        where: {
            id: sessaoId
        },
        select: {
    ...
    if (porIdDireto?.id) return porIdDireto.id;
    const porIdUser = sessaoId ? await prismaClient.tbUser.findFirst({
        where: {
            idUser: sessaoId
        },
        select: {
    ...
    if (porIdUser?.id) return porIdUser.id;
    const porEmail = sessaoEmail ? await prismaClient.tbUser.findFirst({
        where: {
            emailUser: sessaoEmail
        },
        select: {
            id: true
        }
    }) : null;
    if (porEmail?.id) return porEmail.id;
    return null;
}
function to2(n) {
...
async function montarCodigoBm(idCCusto, codigoCentroCusto, mes, ano) {
...
async function GET(request) {
    const canAccess = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$access$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hasModuleAccessForRequest"])(request, 'MEDICAO_CCUSTO');
    if (!canAccess) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        message: 'Sem permissao para acessar BM de medicao'
    }, {
        status: 403
    });
    try {
        ...
        if (idBm) {
            const bm = await prismaClient.tbBmMedicao.findUnique({
                where: {
                    idBm
                }
            });
            if (!bm) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'BM nÃ£o encontrado.'
            }, {
                status: 404
            });
            if (!allowAll && centros.length > 0 && !centros.includes(bm.idCCusto)) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    message: 'Centro de custo nÃ£o permitido.'
                }, {
                    status: 403
                });
            }
        ...
        if (!allowAll && centros.length > 0) {
            where.idCCusto = where.idCCusto ? where.idCCusto : {
                in: centros
            };
        }
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            data: lista.map(mapBm)
        });
    } catch (error) {
        console.error('Erro ao listar BM:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: 'Erro ao listar BM.'
        }, {
            status: 500
        });
    }
...
async function POST(request) {
    ...
    if (!canAccess || !canCreate) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        message: 'Sem permissao para registrar BM'
    }, {
        status: 403
    });
    try {
        const body = await request.json();
        const { idBm, idCCusto, codigoCCusto, descricaoCCusto, mesBm, anoBm, dataInicioMedicao, dataFimMedicao, resumo, resultados, naoInformados, formatoRelatorio } = body || {};
        if (!idCCusto || typeof idCCusto !== 'string') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Centro de custo invÃ¡lido.'
            }, {
                status: 400
            });
        }
        ...
        if (Number.isNaN(ini.getTime()) || Number.isNaN(fim.getTime())) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'PerÃ­odo de mediÃ§Ã£o invÃ¡lido.'
            }, {
                status: 400
            });
        }
        ...
        let bm = null;
        if (idBm) {
            bm = await prismaClient.tbBmMedicao.findUnique({
                where: {
                    idBm
                }
            });
            ...
            if (bm.statusBm !== 'ABERTO') {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    message: 'Somente BM em aberto pode ser atualizado.'
                }, {
                    status: 400
                });
            }
...
async function PUT(request) {
    ...
    if (!canAccess || !canUpdate) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        message: 'Sem permissao para atualizar BM'
    }, {
        status: 403
    });
    try {
        ...
        if (!idBm || typeof idBm !== 'string') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'ID do BM invÃ¡lido.'
            }, {
                status: 400
            });
        }
        const existente = await prismaClient.tbBmMedicao.findUnique({
            where: {
                idBm
            }
        });
        if (!existente) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: 'BM nÃ£o encontrado.'
        }, {
            status: 404
        });
        ...
        if (existente.statusBm !== 'ABERTO' && statusBm !== 'ABERTO') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'BM fechado nÃ£o pode ser editado.'
            }, {
                status: 400
            });
        }
        ...
        if (dataInicioMedicao) {
            ...
            if (Number.isNaN(ini.getTime())) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    message: 'Data de inÃ­cio invÃ¡lida.'
                }, {
                    status: 400
                });
            }
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            data: mapBm(atualizado)
        });
    } catch (error) {
        console.error('Erro ao atualizar BM:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: 'Erro ao atualizar BM.'
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f25a7390._.js.map