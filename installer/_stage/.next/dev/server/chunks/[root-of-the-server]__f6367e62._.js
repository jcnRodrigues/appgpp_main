...
"[project]/src/app/api/ccusto/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const centro = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$CentroCusto$2e$service$2f$centrocusto$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCentroCustoById"])(id);
        if (!centro) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: 'Centro de custo não encontrado'
        }, {
            status: 404
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(centro);
    } catch (error) {
        console.error('Erro ao obter centro de custo:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: 'Erro ao obter centro de custo'
        }, {
            status: 500
        });
    }
...
async function PUT(request, { params }) {
    try {
        ...
        const updated = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$CentroCusto$2e$service$2f$centrocusto$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["atualizarCentroCusto"])(id, {
            codigoCCusto: dados.codigoCCusto,
            descricaoCCusto: dados.descricaoCCusto,
            idEmp_Custo: dados.idEmp_Custo
        });
...
async function DELETE(request, { params }) {
    try {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: 'Centro de custo deletado'
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f6367e62._.js.map