...
"[project]/prisma/generated/prisma/runtime/library.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
async function ml(e, r) {
    ...
    let o = await ir(), s = r.generator?.binaryTargets ?? [], a = s.some((d)=>d.native), l = !s.some((d)=>d.value === o), u = ("TURBOPACK compile-time value", "/ROOT/prisma/generated/prisma/runtime/library.js").match(Qm()) === null, c = {
        searchedLocations: i,
...
async function Wm(e, r) {
    ...
    ("TURBOPACK compile-time value", "/ROOT/prisma/generated/prisma/runtime/library.js").includes("resolveEnginePath") && i.push(ms());
    for (let o of i){
...
"[project]/prisma/generated/prisma/index.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

/* !!! This is code generated by Prisma. Do not edit directly. !!!
/* eslint-disable */ Object.defineProperty(exports, "__esModule", {
    value: true
});
const { PrismaClientKnownRequestError, PrismaClientUnknownRequestError, PrismaClientRustPanicError, PrismaClientInitializationError, PrismaClientValidationError, getPrismaClient, sqltag, empty, join, raw, skip, Decimal, Debug, objectEnumValues, makeStrictEnum, Extensions, warnOnce, defineDmmfProperty, Public, getRuntime, createParam } = __turbopack_context__.r("[project]/prisma/generated/prisma/runtime/library.js [app-route] (ecmascript)");
const Prisma = {};
 ...
 */ const config = {
    ...
    "inlineSchemaHash": "303a45a78c47dc33ab46eac5bc52e24268ed3c97d188bb2a1258dc0802911e35",
    "copyEngine": true
};
...
path.join(("TURBOPACK compile-time value", "/ROOT/prisma/generated/prisma"), "query_engine-windows.dll.node");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/prisma/generated/prisma/index.js [app-route] (ecmascript)");
;
const prisma = globalThis.prisma || new __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$generated$2f$prisma$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PrismaClient"]();
if ("TURBOPACK compile-time truthy", 1) {
    global.prisma = prisma;
}
const __TURBOPACK__default__export__ = prisma;
}),
"[project]/src/back-end/service/Cadastro.service/cadastro.service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"4025af912bb2ecbb17a68cfc5929e7f05042c55d70":"listarPatrimonios","402a1eb905a6e21548b2844c8e860bbdcf59f32add":"contarAlocacoes","403c96fe352353dc01604e55198b7af4a4f1aff1ca":"buscarAlocacaoById","404667f0c45f57653695ca300d5941f525ad7bc7ef":"patrimoniosPorFuncionario","408ee81fb7f3426c64dd2992d9043dcb3a863a96f8":"criarAlocacao","4090e4da10a8c363be921e8872bfdd88b280e7ff9e":"alocacoesPorPatrimonio","40bd275bb3f7322cff844f9f6b9d0645acaf731c22":"deletarAlocacao","40bf5438a313f8195c2fcd1caba96a3f201848c81e":"listarAlocacoes","40ee290211f13c56061bd3dd6997826f56a6a1344b":"listarFuncionarios","604cc1122f97126d95cbc2b0046f9a6952f44bc61f":"transferirAlocacao","60d54fd5c9170c6666fe5d72b4c278457ac42b23f8":"atualizarAlocacao"},"",""] */ __turbopack_context__.s([
    "alocacoesPorPatrimonio",
    ()=>alocacoesPorPatrimonio,
    "atualizarAlocacao",
    ()=>atualizarAlocacao,
    "buscarAlocacaoById",
...
;
;
async function getStatusIdByDescricao(tx, options) {
    ...
    if (options.contains && options.contains.length > 0) {
        ...
        const match = statusList.find((s)=>containsSet.some((c)=>normalize(s.descricaoStatPat).includes(c)));
        if (match) return match.idStatusPat;
    }
    return null;
}
...
async function listarAlocacoes(filtro) {
    const where = buildAlocacaoWhere(filtro);
    ...
    return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbCadastro.findMany({
        where,
        include: {
            tbDevolucao: {
                orderBy: {
...
async function contarAlocacoes(filtro) {
    const where = buildAlocacaoWhere(filtro);
    if (!filtro?.statusIds || filtro.statusIds.length === 0) {
        where.tbStatusPat = {
            descricaoStatPat: {
    ...
    return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbCadastro.count({
        where
    });
}
async function buscarAlocacaoById(idCad) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbCadastro.findUnique({
        where: {
            idCad
        },
        include: {
...
async function criarAlocacao(dados) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].$transaction(async (tx)=>{
        // Validar se o patrimônio existe
        const patrimonio = await tx.tbPatrimonio.findUnique({
            where: {
                idPat: dados.idPatCad
            },
            include: {
                tbStatusPat: true
            }
        ...
        const statusAtivoId = await getStatusIdByDescricao(tx, {
            exact: [
                "ATIVO"
            ]
        });
        ...
        const statusCadastroId = dados.idStatusPatCad || (dados.dataDevPat ? statusDevolvidoId : null) || statusAtivoId || patrimonio.idPat_StatusPat || await getStatusIdByDescricao(tx, {
            contains: [
                "ativo"
            ]
        }) || await getStatusIdByDescricao(tx, {
            contains: [
                "devolv"
            ]
        });
        ...
        if (dados.dataDevPat) {
            if (statusDevolvidoId) {
                await tx.tbPatrimonio.update({
                    ...
                    data: {
                        idPat_StatusPat: statusDevolvidoId
                    }
                });
            }
...
async function atualizarAlocacao(idCad, dados) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].$transaction(async (tx)=>{
        const dataCadastroUpdate = {};
        ...
        if (alocacao.idPatCad) {
            ...
            if (!statusDefinidoExplicitamente && dados.dataDevPat instanceof Date) {
                if (statusDevolvidoId) {
                    ...
                    await tx.tbCadastro.update({
                        ...
                        data: {
                            idStatusPatCad: statusDevolvidoId
                        }
                    });
                }
            ...
            if (statusDefinidoExplicitamente && dados.idStatusPatCad) {
                await tx.tbPatrimonio.update({
                    ...
                    data: {
                        idPat_StatusPat: dados.idStatusPatCad
                    }
                });
            }
...
async function deletarAlocacao(idCad) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbCadastro.delete({
        where: {
            idCad
        }
    });
}
async function listarFuncionarios(centros) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbFuncionario.findMany({
        where: centros && centros.length > 0 ? {
            idCustoFun: {
                in: centros
            }
        } : undefined,
...
async function listarPatrimonios(centros) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbPatrimonio.findMany({
        where: {
            OR: [
                {
                    tbCadastro: {
...
async function transferirAlocacao(idCad, dados) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].$transaction(async (tx)=>{
        ...
        const funcionarioDestino = await tx.tbFuncionario.findUnique({
            where: {
                idMatFun: dados.idMatFunDestino
            }
        });
...
async function patrimoniosPorFuncionario(idMatFun) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbCadastro.findMany({
        where: {
...
async function alocacoesPorPatrimonio(idPat) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbCadastro.findMany({
        where: {
            idPatCad: idPat
        },
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(listarAlocacoes, "40bf5438a313f8195c2fcd1caba96a3f201848c81e", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(contarAlocacoes, "402a1eb905a6e21548b2844c8e860bbdcf59f32add", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(buscarAlocacaoById, "403c96fe352353dc01604e55198b7af4a4f1aff1ca", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(criarAlocacao, "408ee81fb7f3426c64dd2992d9043dcb3a863a96f8", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(atualizarAlocacao, "60d54fd5c9170c6666fe5d72b4c278457ac42b23f8", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(deletarAlocacao, "40bd275bb3f7322cff844f9f6b9d0645acaf731c22", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(listarFuncionarios, "40ee290211f13c56061bd3dd6997826f56a6a1344b", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(listarPatrimonios, "4025af912bb2ecbb17a68cfc5929e7f05042c55d70", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(transferirAlocacao, "604cc1122f97126d95cbc2b0046f9a6952f44bc61f", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(patrimoniosPorFuncionario, "404667f0c45f57653695ca300d5941f525ad7bc7ef", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(alocacoesPorPatrimonio, "4090e4da10a8c363be921e8872bfdd88b280e7ff9e", null);
}),
"[project]/src/back-end/service/Patrimonio.services/patrimonio.service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([
    ...
    ()=>listarPatrimoniosPorCentroCusto,
    "listarTransferenciasCustoPatrimonio",
    ()=>listarTransferenciasCustoPatrimonio,
    "transferirCentroCustoPatrimonio",
    ()=>transferirCentroCustoPatrimonio
]);
var __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/prisma/prisma.ts [app-route] (ecmascript)");
;
...
function isStatusDevolucao(valor) {
...
async function getPatrimonioCardById(id) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbPatrimonio.findUnique({
        where: {
            idP: id
        },
        include: {
...
async function getTipoPatrimonioById(id) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbTipoPat.findUnique({
        where: {
            idTipPat: id
        }
    });
...
async function getStatusPatrimonioById(id) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbStatusPat.findUnique({
        where: {
            idStatusPat: id
        }
    });
...
async function criarPatrimonio(dados) {
    const existente = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbPatrimonio.findUnique({
        where: {
            idPat: dados.idPat
        },
        include: {
    ...
    if (existente) {
        ...
        const ultimaDevolucao = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbDevolucao.findFirst({
            where: {
                idPatrimonio: existente.idPat,
                dataFimDevolucao: null
            },
            orderBy: {
                dataInicioDevolucao: 'desc'
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbPatrimonioHistorico.create({
            data: {
        ...
        if (ultimaDevolucao) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbDevolucao.update({
                where: {
                    idDevolucao: ultimaDevolucao.idDevolucao
                },
                data: {
        ...
        return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbPatrimonio.update({
            where: {
                idP: existente.idP
            },
            data: {
    ...
    return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbPatrimonio.create({
        data: {
            idPat: dados.idPat,
            descricaoPat: dados.descricaoPat,
            descricaoDetalhadaPat: dados.descricaoDetalhadaPat,
...
async function listarPatrimoniosPorCentroCusto(idCCusto, options) {
    ...
    const patrimonios = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbPatrimonio.findMany({
        where: dataFimMedicao ? {
            ...
            OR: [
                ...
                {
                    dataSaiPat: {
                        gte: dataInicioMedicao || dataFimMedicao
                    }
                }
            ],
            AND: [
    ...
    const calcularMsNoCentro = (pat)=>{
        const transferencias = [
            ...pat.tbTransferenciaCustoPatrimonio
        ].sort((a, b)=>a.dataTransferencia.getTime() - b.dataTransferencia.getTime());
        ...
        const primeiraDevolucaoMs = pat.tbDevolucao.map((d)=>d.dataInicioDevolucao.getTime()).sort((a, b)=>a - b)[0];
        const limiteSaida = Math.min(pat.dataSaiPat ? pat.dataSaiPat.getTime() : Number.POSITIVE_INFINITY, primeiraDevolucaoMs ?? Number.POSITIVE_INFINITY);
        let msNoCentro = 0;
        const somarSobreposicao = (segInicio, segFim)=>{
...
async function listarTransferenciasCustoPatrimonio(idPatrimonio) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbTransferenciaCustoPatrimonio.findMany({
        where: {
            idPatrimonio
        },
        include: {
...
async function transferirCentroCustoPatrimonio(params) {
    const patrimonio = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbPatrimonio.findUnique({
        where: {
            idP: params.idPatrimonio
        },
        select: {
            idP: true,
            valorPat: true,
    ...
    const centroDestino = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbCCusto.findUnique({
        where: {
            idCCusto: params.idCustoDestino
        },
        select: {
            idCCusto: true
        }
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].$transaction(async (tx)=>{
...
async function getTiposPatrimonio() {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbTipoPat.findMany();
}
async function getStatusPatrimonio() {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbStatusPat.findMany();
}
async function getCentrosCusto() {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbCCusto.findMany();
}
async function contarPatrimonios(filtro) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbPatrimonio.count({
        where: buildPatrimonioWhere(filtro)
    });
}
}),
...
"[project]/src/lib/date-input.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/api/cadastro/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$Cadastro$2e$service$2f$cadastro$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/back-end/service/Cadastro.service/cadastro.service.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$Patrimonio$2e$services$2f$patrimonio$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/back-end/service/Patrimonio.services/patrimonio.service.ts [app-route] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$date$2d$input$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/date-input.ts [app-route] (ecmascript)");
;
;
;
;
...
async function GET(request) {
    ...
    if (!canAccess) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        message: 'Sem permissao para acessar alocacoes'
    }, {
        status: 403
    });
    try {
        ...
        const { centros, allowAll } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$access$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCentrosFiltro"])(request);
        ...
        if (opcoes === 'true') {
            const [funcionarios, patrimonios, statusPatrimonio] = await Promise.all([
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$Cadastro$2e$service$2f$cadastro$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listarFuncionarios"])(filtroCentros),
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$Cadastro$2e$service$2f$cadastro$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listarPatrimonios"])(filtroCentros),
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$Patrimonio$2e$services$2f$patrimonio$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getStatusPatrimonio"])()
            ]);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                funcionarios,
                patrimonios,
        ...
        const alocacoes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$Cadastro$2e$service$2f$cadastro$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listarAlocacoes"])({
        ...
        const total = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$Cadastro$2e$service$2f$cadastro$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["contarAlocacoes"])({
            idMatFun: idMatFun || undefined,
            idPat: idPat || undefined,
            funcionarioBusca: funcionarioBusca || undefined,
            patrimonioBusca: patrimonioBusca || undefined,
...
async function POST(request) {
    const canAccess = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$access$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hasModuleAccessForRequest"])(request, 'ALOCACOES');
    const canCreate = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$access$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hasActionPermissionForRequest"])(request, 'CREATE');
    if (!canAccess || !canCreate) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        message: 'Sem permissao para criar alocacao'
    }, {
        status: 403
    });
    try {
        ...
        const alocacao = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$Cadastro$2e$service$2f$cadastro$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["criarAlocacao"])({
            idPatCad: dados.idPatCad,
            idMatFunCad: dados.idMatFunCad,
            dataCadPat: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$date$2d$input$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseOptionalDateInput"])(dados.dataCadPat),
            dataDevPat: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$date$2d$input$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseOptionalDateInput"])(dados.dataDevPat),
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(alocacao, {
            status: 201
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4f0f5161._.js.map