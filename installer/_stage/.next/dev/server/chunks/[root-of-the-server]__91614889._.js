...
async function POST(request) {
    ...
    if (!canAccess) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: 'Sem permissao para acessar monitoramento'
    }, {
        status: 403
    });
    const { apiKey } = await request.json();
    const savedConfig = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$unifi$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getUnifiConfig"])();
    ...
    try {
        ...
        const sites = normalizeList(sitesPayload).map((site)=>({
                id: String(site.siteId || site.id || ''),
                name: String(site.meta?.name || site.name || site.displayName || 'default'),
                label: String(site.meta?.desc || site.meta?.name || site.name || 'Site sem nome'),
        ...
        const results = await Promise.all(sites.map(async (site)=>{
            ...
            return clients.map((client, idx)=>({
                    ...
                    name: String(client.name || client.hostname || client.displayName || client.essid || client.ap_name || 'Cliente sem nome'),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__91614889._.js.map