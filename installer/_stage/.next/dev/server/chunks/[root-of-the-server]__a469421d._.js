...
async function POST(request) {
    try {
        ...
        if (Number.isNaN(ini.getTime()) || Number.isNaN(fim.getTime())) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Período de medição inválido.'
            }, {
                status: 400
            });
        }
...
async function PUT(request) {
    try {
        ...
        if (existente.statusBm !== 'ABERTO' && statusBm !== 'ABERTO') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'BM fechado não pode ser editado.'
            }, {
                status: 400
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a469421d._.js.map