...
function hasAnyExplicitActionToken(formularios) {
    return Object.values(ACTION_TOKENS).some((token)=>formularios.includes(token));
}
function hasActionPermission(formulariosRaw, action) {
    ...
    // Compatibilidade: usuários legados sem PERM_* mantêm acesso por formulário.
    if (!hasAnyExplicitActionToken(formularios)) {
        return FORMULARIOS_BASE.some((f)=>formularios.includes(f));
    }
    return false;
}
...
"[project]/src/app/api/patrimonio/[id]/transferencias/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        if (!canAccess) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: 'Sem permissao para acessar transferencias'
        }, {
            status: 403
        });
        ...
        if (!patrimonio) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Patrimonio nao encontrado'
            }, {
                status: 404
            });
        }
        ...
        const historico = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$Patrimonio$2e$services$2f$patrimonio$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listarTransferenciasCustoPatrimonio"])(id);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(historico);
    } catch (error) {
        console.error('Erro ao listar transferencias:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: 'Erro ao listar transferencias'
        }, {
            status: 500
        });
    }
...
async function POST(request, { params }) {
    try {
        ...
        if (!canAccess || !canUpdate) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: 'Sem permissao para transferir patrimonio'
        }, {
            status: 403
        });
        const { id } = await params;
        ...
        if (!body?.idCustoDestino) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Centro de custo de destino e obrigatorio'
            }, {
                status: 400
            });
        }
        ...
        if (!allowAll && centros.length > 0) {
            ...
            if (!centros.includes(centroAtual) || !centros.includes(body.idCustoDestino)) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    message: 'Sem permissao para transferir entre estes centros de custo'
                }, {
                    status: 403
                });
            }
        }
        let idUserTransferencia;
        ...
        const atualizado = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$Patrimonio$2e$services$2f$patrimonio$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["transferirCentroCustoPatrimonio"])({
            idPatrimonio: id,
            idCustoDestino: body.idCustoDestino,
            observacao: body.observacao,
            dataTransferencia: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$date$2d$input$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseOptionalDateInput"])(body.dataTransferencia),
            idUserTransferencia
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(atualizado);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0634b24e._.js.map