...
"[project]/src/app/api/sistema-dados/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function addIgnoredRow(ignored, table, row, motivo) {
    ignored.push({
        table,
        row,
        motivo
...
function hasImportExportAccess(sessionUser) {
    const formularios = sessionUser?.formularios;
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$permissions$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hasModuleAccess"])(formularios || [], "IMPORTACAO_EXPORTACAO") || (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$permissions$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hasModuleAccess"])(formularios || [], "ACESSO_USUARIOS");
}
async function validateCentroAccess(request, centroId) {
...
function buildSourceIndex(rows, idField, searchableFields) {
    const index = new Map();
...
function resolveSourceId(row, directField, index, fallbackFields = []) {
...
function mapResolvedId(targetMap, row, directField, sourceIndex, fallbackFields = []) {
    const sourceId = resolveSourceId(row, directField, sourceIndex, fallbackFields);
    if (!sourceId) return null;
    return targetMap.get(sourceId) ?? null;
}
function enrichExportData(data) {
    const statusFunById = new Map(data.tbStatusFun.map((row)=>[
            row.idStatusFun,
            row.descricaoStatusFun ?? null
        ]));
    const funcaoById = new Map(data.tbFuncao.map((row)=>[
            row.idFuncao,
            row.nomeFuncao ?? null
        ]));
    const tipoPatById = new Map(data.tbTipoPat.map((row)=>[
            row.idTipPat,
            row.descricaoTipPat ?? null
        ]));
    const statusPatById = new Map(data.tbStatusPat.map((row)=>[
            row.idStatusPat,
            row.descricaoStatPat ?? null
        ]));
    const empresaById = new Map(data.tbEmpresa.map((row)=>[
            row.idEmp,
            firstString(row.fantasiaEmpresa, row.razaoEmpresa, row.cnpjEmpresa)
        ]));
    const ccustoById = new Map(data.tbCCusto.map((row)=>[
            row.idCCusto,
            firstString(row.descricaoCCusto, row.codigoCCusto)
        ]));
    const licencaById = new Map(data.tbLicenca.map((row)=>[
            row.idLic,
            row.descricaoLic ?? null
        ]));
    const funcionarioById = new Map(data.tbFuncionario.map((row)=>[
            row.idF,
            firstString(row.idMatFun, row.nomeFun)
        ]));
    const funcionarioByMat = new Map(data.tbFuncionario.map((row)=>[
            row.idMatFun,
            row.nomeFun ?? null
        ]));
    const patrimonioByIdPat = new Map(data.tbPatrimonio.map((row)=>[
            row.idPat,
            row.descricaoPat ?? null
        ]));
    const userById = new Map(data.tbUser.map((row)=>[
            row.id,
            firstString(row.emailUser, row.nomeUser, row.idUser)
        ]));
    return {
        ...data,
        tbCCusto: data.tbCCusto.map((row)=>({
                ...row,
                idEmp_Custo_descricao: row.idEmp_Custo ? empresaById.get(row.idEmp_Custo) ?? null : null
            })),
        tbFuncionario: data.tbFuncionario.map((row)=>({
                ...row,
        ...
        tbPatrimonio: data.tbPatrimonio.map((row)=>({
                ...row,
        ...
        tbHasLicencaFuncionario: data.tbHasLicencaFuncionario.map((row)=>({
                ...row,
        ...
        tbCadastro: data.tbCadastro.map((row)=>({
                ...row,
...
async function buildExportData(centroId) {
    if (!centroId) {
        const [tbUser, tbStatusFun, tbFuncao, tbTipoPat, tbStatusPat, tbEmpresa, tbCCusto, tbLicenca, tbFuncionario, tbPatrimonio, tbHasLicencaFuncionario, tbCadastro] = await Promise.all([
            __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbUser.findMany(),
            __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbStatusFun.findMany(),
            __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbFuncao.findMany(),
            __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbTipoPat.findMany(),
            __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbStatusPat.findMany(),
            __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbEmpresa.findMany(),
            __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbCCusto.findMany(),
            __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbLicenca.findMany(),
            __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbFuncionario.findMany(),
            __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbPatrimonio.findMany(),
            __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbHasLicencaFuncionario.findMany(),
            __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbCadastro.findMany()
        ]);
        return {
            tbUser,
            tbStatusFun,
    ...
    const tbCCusto = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbCCusto.findMany({
        where: {
            idCCusto: centroId
        }
    });
    const tbFuncionario = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbFuncionario.findMany({
        where: {
            idCustoFun: centroId
        }
    });
    const tbPatrimonio = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbPatrimonio.findMany({
        where: {
    ...
    const tbHasLicencaFuncionario = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbHasLicencaFuncionario.findMany({
        where: {
            idFunc: {
                in: [
                    ...funcionarioIds
    ...
    const tbCadastro = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbCadastro.findMany({
        where: {
            OR: [
                {
                    idMatFunCad: {
    ...
    const statusPatIds = new Set([
        ...statusPatIdsFromPat,
        ...statusPatIdsFromCadastro
    ]);
    const [tbUser, tbStatusFun, tbFuncao, tbTipoPat, tbStatusPat, tbEmpresa, tbLicenca] = await Promise.all([
        __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbUser.findMany({
            where: {
                id: {
                    in: [
...
async function importAllData(data) {
    ...
    const statusFunMap = new Map();
    const funcaoMap = new Map();
    const tipoPatMap = new Map();
    const statusPatMap = new Map();
    const empresaMap = new Map();
    const ccustoMap = new Map();
    const licencaMap = new Map();
    const funcionarioMap = new Map();
    const userSourceIndex = buildSourceIndex(data.tbUser, "id", [
        "emailUser",
        "idUser",
        "nomeUser"
    ]);
    const statusFunSourceIndex = buildSourceIndex(data.tbStatusFun, "idStatusFun", [
        "descricaoStatusFun"
    ]);
    const funcaoSourceIndex = buildSourceIndex(data.tbFuncao, "idFuncao", [
        "nomeFuncao"
    ]);
    const tipoPatSourceIndex = buildSourceIndex(data.tbTipoPat, "idTipPat", [
        "descricaoTipPat"
    ]);
    const statusPatSourceIndex = buildSourceIndex(data.tbStatusPat, "idStatusPat", [
        "descricaoStatPat"
    ]);
    const empresaSourceIndex = buildSourceIndex(data.tbEmpresa, "idEmp", [
        "fantasiaEmpresa",
        "razaoEmpresa",
        "cnpjEmpresa"
    ]);
    const ccustoSourceIndex = buildSourceIndex(data.tbCCusto, "idCCusto", [
        "descricaoCCusto",
        "codigoCCusto"
    ]);
    const licencaSourceIndex = buildSourceIndex(data.tbLicenca, "idLic", [
        "descricaoLic"
    ]);
    const funcionarioSourceIndex = buildSourceIndex(data.tbFuncionario, "idF", [
        "idMatFun",
        "nomeFun"
    ]);
    const matriculasFuncionarioNoArquivo = new Set();
    const tbUserPrepared = data.tbUser.map((item)=>{
    ...
    const tbStatusFunPrepared = data.tbStatusFun.flatMap((item, index)=>{
    ...
    const tbFuncaoPrepared = data.tbFuncao.flatMap((item, index)=>{
        if (!item?.nomeFuncao) {
    ...
    const tbTipoPatPrepared = data.tbTipoPat.map((item)=>{
        const id = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["randomUUID"])();
    ...
    const tbStatusPatPrepared = data.tbStatusPat.flatMap((item, index)=>{
    ...
    const tbEmpresaPrepared = data.tbEmpresa.map((item)=>{
        const id = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["randomUUID"])();
    ...
    const tbCCustoPrepared = data.tbCCusto.map((item)=>{
        const id = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["randomUUID"])();
        ...
        return {
            ...
            idEmp_Custo: mapResolvedId(empresaMap, item, "idEmp_Custo", empresaSourceIndex, [
                "idEmp_Custo_descricao"
            ])
        };
    });
    const tbLicencaPrepared = data.tbLicenca.flatMap((item, index)=>{
    ...
    const tbFuncionarioPrepared = data.tbFuncionario.flatMap((item, index)=>{
        ...
        return [
            {
                ...
                idFuncaoFun: mapResolvedId(funcaoMap, item, "idFuncaoFun", funcaoSourceIndex, [
                    "idFuncaoFun_descricao"
                ]),
                idUserFun: mapResolvedId(userIdMap, item, "idUserFun", userSourceIndex, [
                    "idUserFun_descricao"
                ]),
                idStatusFun: mapResolvedId(statusFunMap, item, "idStatusFun", statusFunSourceIndex, [
                    "idStatusFun_descricao"
                ]),
                idCustoFun: mapResolvedId(ccustoMap, item, "idCustoFun", ccustoSourceIndex, [
                    "idCustoFun_descricao"
                ])
            }
        ];
    });
    const tbPatrimonioPrepared = data.tbPatrimonio.flatMap((item, index)=>{
        ...
        return [
            {
                idP: (0, __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["randomUUID"])(),
                idPat: item.idPat,
                ...
                idPat_TipoPat: mapResolvedId(tipoPatMap, item, "idPat_TipoPat", tipoPatSourceIndex, [
                    "idPat_TipoPat_descricao"
                ]),
                idPat_StatusPat: mapResolvedId(statusPatMap, item, "idPat_StatusPat", statusPatSourceIndex, [
                    "idPat_StatusPat_descricao"
                ]),
                idPat_CustoPat: mapResolvedId(ccustoMap, item, "idPat_CustoPat", ccustoSourceIndex, [
                    "idPat_CustoPat_descricao"
                ])
            }
        ];
    });
    const tbHasLicencaPrepared = data.tbHasLicencaFuncionario.flatMap((item, index)=>{
        const idFunc = mapResolvedId(funcionarioMap, item, "idFunc", funcionarioSourceIndex, [
            "idFunc_descricao"
        ]);
        const idLinc = mapResolvedId(licencaMap, item, "idLinc", licencaSourceIndex, [
            "idLinc_descricao"
        ]);
        ...
        return [
            {
                idHas: (0, __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["randomUUID"])(),
                idFunc,
                idLinc,
                dataInicio,
                dataVencimetno
    ...
    const tbCadastroPrepared = data.tbCadastro.flatMap((item, index)=>{
        const statusMapped = mapResolvedId(statusPatMap, item, "idStatusPatCad", statusPatSourceIndex, [
        ...
        return [
            {
                idCad: (0, __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["randomUUID"])(),
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].$transaction(async (tx)=>{
        ...
        if (tbUserPrepared.length > 0) await tx.tbUser.createMany({
            data: tbUserPrepared
        });
        if (tbStatusFunPrepared.length > 0) await tx.tbStatusFun.createMany({
            data: tbStatusFunPrepared
        });
        if (tbFuncaoPrepared.length > 0) await tx.tbFuncao.createMany({
            data: tbFuncaoPrepared
        });
        if (tbTipoPatPrepared.length > 0) await tx.tbTipoPat.createMany({
            data: tbTipoPatPrepared
        });
        if (tbStatusPatPrepared.length > 0) await tx.tbStatusPat.createMany({
            data: tbStatusPatPrepared
        });
        if (tbEmpresaPrepared.length > 0) await tx.tbEmpresa.createMany({
            data: tbEmpresaPrepared
        });
        if (tbCCustoPrepared.length > 0) await tx.tbCCusto.createMany({
            data: tbCCustoPrepared
        });
        if (tbLicencaPrepared.length > 0) await tx.tbLicenca.createMany({
            data: tbLicencaPrepared
        });
        if (tbFuncionarioPrepared.length > 0) await tx.tbFuncionario.createMany({
            data: tbFuncionarioPrepared
        });
        if (tbPatrimonioPrepared.length > 0) await tx.tbPatrimonio.createMany({
            data: tbPatrimonioPrepared
        });
        if (tbHasLicencaPrepared.length > 0) await tx.tbHasLicencaFuncionario.createMany({
            data: tbHasLicencaPrepared
        });
        if (tbCadastroPrepared.length > 0) await tx.tbCadastro.createMany({
            data: tbCadastroPrepared
        });
    });
    return {
        imported: {
...
async function importByCentro(data, centroId) {
    const ignored = [];
    const tbCCusto = data.tbCCusto.filter((c)=>c.idCCusto === centroId);
    const tbFuncionario = data.tbFuncionario.filter((f)=>f.idCustoFun === centroId);
    const tbPatrimonio = data.tbPatrimonio.filter((p)=>p.idPat_CustoPat === centroId);
    ...
    await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].$transaction(async (tx)=>{
        ...
        for(let index = 0; index < data.tbStatusFun.length; index += 1){
            ...
            const existing = await tx.tbStatusFun.findFirst({
                where: {
                    descricaoStatusFun: row.descricaoStatusFun
                }
            });
            if (existing) {
            ...
            const created = await tx.tbStatusFun.create({
                data: {
                    idStatusFun: (0, __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["randomUUID"])(),
                    descricaoStatusFun: row.descricaoStatusFun
                }
            });
        ...
        for(let index = 0; index < data.tbFuncao.length; index += 1){
            ...
            const created = await tx.tbFuncao.create({
                data: {
                    idFuncao: (0, __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["randomUUID"])(),
                    nomeFuncao: row.nomeFuncao
                }
            });
        ...
        for (const row of data.tbTipoPat){
            const existing = await tx.tbTipoPat.findFirst({
                where: {
                    descricaoTipPat: row.descricaoTipPat ?? null
                }
            });
            if (existing) {
            ...
            const created = await tx.tbTipoPat.create({
                data: {
                    idTipPat: (0, __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["randomUUID"])(),
                    descricaoTipPat: row.descricaoTipPat ?? null
                }
            });
        ...
        for(let index = 0; index < data.tbStatusPat.length; index += 1){
            ...
            const existing = await tx.tbStatusPat.findFirst({
                where: {
                    descricaoStatPat: row.descricaoStatPat
                }
            });
            if (existing) {
            ...
            const created = await tx.tbStatusPat.create({
                data: {
                    idStatusPat: (0, __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["randomUUID"])(),
                    descricaoStatPat: row.descricaoStatPat
                }
            });
        ...
        for(let index = 0; index < data.tbLicenca.length; index += 1){
            ...
            const created = await tx.tbLicenca.create({
                data: {
                    idLic: (0, __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["randomUUID"])(),
                    descricaoLic: row.descricaoLic
                }
            });
        ...
        const idsFuncDb = funcsDb.map((f)=>f.idF);
        const matsDb = funcsDb.map((f)=>f.idMatFun);
        const idsPatDb = patsDb.map((p)=>p.idP);
        const codPatDb = patsDb.map((p)=>p.idPat);
        ...
        if (tbFuncionario.length > 0) {
            const matriculasArquivo = Array.from(new Set(tbFuncionario.map((row)=>firstString(row?.idMatFun)).filter((value)=>Boolean(value))));
            const matriculasEmOutrosCentros = new Set((await tx.tbFuncionario.findMany({
                where: {
                    idMatFun: {
                        in: matriculasArquivo
                    },
                    NOT: {
                        idCustoFun: centroId
                    }
            ...
            })).map((row)=>row.idMatFun));
            const matriculasProcessadas = new Set();
            funcData = tbFuncionario.flatMap((row, index)=>{
                ...
                if (matriculasEmOutrosCentros.has(idMatFun)) {
                    addIgnoredRow(ignored, "tbFuncionario", index + 1, `idMatFun ja existe em outro centro e nao pode ser sobrescrito: ${idMatFun}.`);
                    return [];
                }
                matriculasProcessadas.add(idMatFun);
                const idF = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["randomUUID"])();
                ...
                return [
                    {
                        ...
                        idFuncaoFun: mapResolvedId(funcaoMap, row, "idFuncaoFun", funcaoSourceIndex, [
                            "idFuncaoFun_descricao"
                        ]),
                        idUserFun: mapResolvedId(userMap, row, "idUserFun", userSourceIndex, [
                            "idUserFun_descricao"
                        ]),
                        idStatusFun: mapResolvedId(statusFunMap, row, "idStatusFun", statusFunSourceIndex, [
                            "idStatusFun_descricao"
                        ]),
                        idCustoFun: centroId
                    }
            ...
            if (funcData.length > 0) {
                await tx.tbFuncionario.createMany({
                    data: funcData
                });
            }
        }
        ...
        if (tbPatrimonio.length > 0) {
            patData = tbPatrimonio.flatMap((row, index)=>{
                ...
                return [
                    {
                        ...
                        valorPat,
                        idPat_TipoPat: mapResolvedId(tipoPatMap, row, "idPat_TipoPat", tipoPatSourceIndex, [
                            "idPat_TipoPat_descricao"
                        ]),
                        idPat_StatusPat: mapResolvedId(statusPatMap, row, "idPat_StatusPat", statusPatSourceIndex, [
                            "idPat_StatusPat_descricao"
                        ]),
                        idPat_CustoPat: centroId
                    }
            ...
            if (patData.length > 0) {
                await tx.tbPatrimonio.createMany({
                    data: patData
                });
            }
        }
        const hasByCentro = tbHasLicenca.flatMap((row, index)=>{
            const idFunc = mapResolvedId(funcionarioMap, row, "idFunc", funcionarioSourceIndex, [
                "idFunc_descricao"
            ]);
            const idLinc = mapResolvedId(licencaMap, row, "idLinc", licencaSourceIndex, [
                "idLinc_descricao"
            ]);
        ...
        if (hasByCentro.length > 0) {
            await tx.tbHasLicencaFuncionario.createMany({
                data: hasByCentro
            });
        }
        const matSet = new Set(tbFuncionario.map((f)=>f.idMatFun));
        const patSet = new Set(tbPatrimonio.map((p)=>p.idPat));
        const cadByCentro = tbCadastro.filter((c)=>matSet.has(c.idMatFunCad) || patSet.has(c.idPatCad)).flatMap((row, index)=>{
            const statusMapped = mapResolvedId(statusPatMap, row, "idStatusPatCad", statusPatSourceIndex, [
                "idStatusPatCad_descricao"
            ]);
            if (!statusMapped) {
                addIgnoredRow(ignored, "tbCadastro", index + 1, "idStatusPatCad nao mapeado.");
        ...
        if (cadByCentro.length > 0) {
            await tx.tbCadastro.createMany({
                data: cadByCentro
            });
        }
    });
...
async function GET(request) {
    try {
        ...
        const sessionUser = session?.user ?? undefined;
        if (!session?.user) {
...
async function POST(request) {
    try {
        ...
        const importResult = centroId ? await importByCentro(data, centroId) : await importAllData(data);
        const ignoredCount = importResult.ignored.length;
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: centroId ? `Importacao por centro de custo concluida com UUIDs novos.${ignoredCount > 0 ? ` ${ignoredCount} linha(s) inconsistente(s) foram ignoradas.` : ""}` : `Importacao completa concluida com UUIDs novos.${ignoredCount > 0 ? ` ${ignoredCount} linha(s) inconsistente(s) foram ignoradas.` : ""}`,
            scope: {
                centroId: centroId || null
            },
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5884d053._.js.map