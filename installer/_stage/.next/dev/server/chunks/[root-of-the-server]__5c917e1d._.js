...
"[project]/src/back-end/service/Dashboard.service/dashboard.service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";

/* __next_internal_action_entry_do_not_use__ [{"40158f2986fb98a9f90013ec0591cdac4019bee93c":"alocacoesAoLongoDoTempo","40215ef5a0de825b5d3c9c0f3d7ca98930300e1d9a":"alocacoesPorCentroCustoETipo","402bb1bbe21425377581b84daff07207e7d7088d03":"alocacoesPorCentroCusto","402ddecd5023ad5fc7a0be2787d0c387d65ab61349":"contarFuncionarios","406c5621f62662cd14a3f616d8d558ec4c7fb0d58f":"alocacoesEvolucaoPorCentroCusto","40873bb55c5705a3033082f5f1cfa993e9ce765fa7":"funcionariosPorCentroCusto","4087a119de5b92756f7d1c4136c5cd531dfbf8cc35":"resumoCentrosCusto","40f5d6fb1cb93e3b8ff723669dab6068d452e9fce8":"funcionariosPorStatus"},"",""] */ __turbopack_context__.s([
    "alocacoesAoLongoDoTempo",
    ()=>alocacoesAoLongoDoTempo,
    "alocacoesEvolucaoPorCentroCusto",
    ()=>alocacoesEvolucaoPorCentroCusto,
    "alocacoesPorCentroCusto",
    ()=>alocacoesPorCentroCusto,
    "alocacoesPorCentroCustoETipo",
    ()=>alocacoesPorCentroCustoETipo,
    "contarFuncionarios",
    ()=>contarFuncionarios,
...
;
;
function buildCentroFiltro(centros) {
    if (!centros || centros.length === 0) return undefined;
    return {
        in: centros
    };
}
async function contarFuncionarios(centros) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbFuncionario.count({
        where: buildCentroFiltro(centros) ? {
            idCustoFun: buildCentroFiltro(centros)
        } : undefined
    });
}
async function funcionariosPorStatus(centros) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbStatusFun.findMany({
        include: {
            tbFuncionario: {
                where: buildCentroFiltro(centros) ? {
                    idCustoFun: buildCentroFiltro(centros)
...
async function funcionariosPorCentroCusto(centros) {
    return await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbCCusto.findMany({
        where: buildCentroFiltro(centros) ? {
            idCCusto: buildCentroFiltro(centros)
        } : undefined,
        select: {
            idCCusto: true,
...
async function alocacoesPorCentroCusto(centros) {
    const centrosFiltro = buildCentroFiltro(centros);
    const centrosDb = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbCCusto.findMany({
        where: centrosFiltro ? {
            idCCusto: centrosFiltro
        } : undefined,
        select: {
            idCCusto: true,
            descricaoCCusto: true,
...
async function alocacoesPorCentroCustoETipo(centros) {
    const centrosFiltro = buildCentroFiltro(centros);
    const centrosDb = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbCCusto.findMany({
        where: centrosFiltro ? {
            idCCusto: centrosFiltro
...
async function alocacoesAoLongoDoTempo(centros) {
    const centrosFiltro = buildCentroFiltro(centros);
    const alocacoes = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbCadastro.findMany({
        select: {
            dataCadPat: true
        },
        where: {
...
async function alocacoesEvolucaoPorCentroCusto(centros) {
    const centrosFiltro = buildCentroFiltro(centros);
    const alocacoes = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbCadastro.findMany({
        select: {
            dataCadPat: true,
    ...
    for (const aloc of alocacoes){
        ...
        const centro = aloc.tbPatrimonio?.tbCCusto ? aloc.tbPatrimonio.tbCCusto.descricaoCCusto || aloc.tbPatrimonio.tbCCusto.codigoCCusto || aloc.tbPatrimonio.tbCCusto.idCCusto : 'Sem centro';
...
async function resumoCentrosCusto(centros) {
    const centrosFiltro = buildCentroFiltro(centros);
    const centrosDb = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbCCusto.findMany({
        where: centrosFiltro ? {
            idCCusto: centrosFiltro
    ...
    const cads = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbCadastro.findMany({
        select: {
            idPatCad: true,
            dataDevPat: true,
            tbStatusPat: {
    ...
    const ativosPorCentro = new Map();
    const devolvidosPorCentro = new Map();
    const transferidosPorCentro = new Map();
    for (const cad of cads){
        ...
        if (isAtivo && cad.idPatCad) {
            if (!ativosPorCentro.has(centroId)) ativosPorCentro.set(centroId, new Set());
    ...
    const devolucoes = await __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].tbDevolucao.findMany({
        select: {
            idDevolucao: true,
            tbCadastro: {
                select: {
    ...
    for (const dev of devolucoes){
        const centroId = dev.tbCadastro?.tbFuncionario?.idCustoFun || dev.tbCadastro?.tbPatrimonio?.idPat_CustoPat || dev.tbPatrimonio?.idPat_CustoPat || null;
        if (!centroId || !centroIds.has(centroId)) continue;
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(contarFuncionarios, "402ddecd5023ad5fc7a0be2787d0c387d65ab61349", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(funcionariosPorStatus, "40f5d6fb1cb93e3b8ff723669dab6068d452e9fce8", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(funcionariosPorCentroCusto, "40873bb55c5705a3033082f5f1cfa993e9ce765fa7", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(alocacoesPorCentroCusto, "402bb1bbe21425377581b84daff07207e7d7088d03", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(alocacoesPorCentroCustoETipo, "40215ef5a0de825b5d3c9c0f3d7ca98930300e1d9a", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(alocacoesAoLongoDoTempo, "40158f2986fb98a9f90013ec0591cdac4019bee93c", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(alocacoesEvolucaoPorCentroCusto, "406c5621f62662cd14a3f616d8d558ec4c7fb0d58f", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(resumoCentrosCusto, "4087a119de5b92756f7d1c4136c5cd531dfbf8cc35", null);
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$Dashboard$2e$service$2f$dashboard$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/back-end/service/Dashboard.service/dashboard.service.ts [app-route] (ecmascript)");
...
async function GET(request) {
    try {
        const canAccess = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$access$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hasModuleAccessForRequest"])(request, 'DASHBOARD');
        if (!canAccess) {
        ...
        if (tipo === 'centro') {
            const dados = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$Dashboard$2e$service$2f$dashboard$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["alocacoesPorCentroCusto"])(filtroCentros);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(dados);
        }
        if (tipo === 'tempo') {
            const dados = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$Dashboard$2e$service$2f$dashboard$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["alocacoesAoLongoDoTempo"])(filtroCentros);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(dados);
        }
        if (tipo === 'resumo') {
            const [totalPatrimonios, totalFuncionarios] = await Promise.all([
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$Patrimonio$2e$services$2f$patrimonio$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["contarPatrimonios"])({
                    centros: filtroCentros
                }),
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$Dashboard$2e$service$2f$dashboard$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["contarFuncionarios"])(filtroCentros)
            ]);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                totalPatrimonios,
                totalFuncionarios
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5c917e1d._.js.map