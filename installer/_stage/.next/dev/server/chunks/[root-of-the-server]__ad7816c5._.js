...
"[project]/src/app/api/licenca/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    const canAccess = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$access$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hasModuleAccessForRequest"])(request, 'LICENCAS_SOFTWARE');
    if (!canAccess) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        message: 'Sem permissao para acessar licencas'
    }, {
        status: 403
    });
    try {
        ...
        const licencas = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$Licenca$2e$service$2f$licenca$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listarLicencas"])({
            descricao,
            skip,
            take
        });
        const total = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$Licenca$2e$service$2f$licenca$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["contarLicencas"])(descricao);
...
async function POST(request) {
    ...
    if (!canAccess || !canCreate) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        message: 'Sem permissao para criar licenca'
    }, {
        status: 403
    });
    try {
        ...
        const licenca = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$Licenca$2e$service$2f$licenca$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["criarLicenca"])({
            descricaoLic: dados.descricaoLic
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(licenca, {
            status: 201
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ad7816c5._.js.map