...
"[project]/src/app/api/usuarios-acesso/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        const canAccess = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$access$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hasModuleAccessForRequest"])(request, 'ACESSO_USUARIOS');
        if (!canAccess) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Sem permissao para acessar usuarios'
            }, {
                status: 403
            });
        }
        ...
        if (id) {
            const usuario = await prismaClient.tbUser.findUnique({
                where: {
                    id
                }
            });
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            message: 'Erro ao listar acessos'
        }, {
            status: 500
        });
    }
...
async function POST(request) {
    try {
        ...
        if (!canAccess || !canCreate) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Sem permissao para criar usuarios de acesso'
            }, {
                status: 403
            });
        }
        ...
        if (authType === 'LOCAL' && !senha) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Senha obrigatoria para acesso local'
            }, {
                status: 400
            });
        }
        ...
        if (existente) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Ja existe acesso para este email e tipo'
            }, {
                status: 409
            });
        }
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            data: {
                ...
                authType: created.authTypeUser || 'GOOGLE',
                centros,
                formularios,
                status: created.statusUser || 'ATIVO',
...
async function PUT(request) {
    try {
        ...
        if (!canAccess || !canUpdate) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Sem permissao para alterar usuarios de acesso'
            }, {
                status: 403
            });
        }
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            data: {
                ...
                authType: updated.authTypeUser || 'GOOGLE',
                centros,
                formularios,
                status: updated.statusUser || 'ATIVO',
...
async function DELETE(request) {
    try {
        ...
        if (!canAccess || !canDelete) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Sem permissao para deletar'
            }, {
                status: 403
            });
        }
        ...
        await prismaClient.tbUser.delete({
            where: {
                id
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__02a0dd58._.js.map