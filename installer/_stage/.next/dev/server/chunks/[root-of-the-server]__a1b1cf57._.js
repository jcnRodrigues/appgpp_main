...
"[project]/src/app/api/funcionario/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    try {
        ...
        const funcionarios = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$Funcionario$2e$service$2f$funcionario$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listarFuncionarios"])({
            nome: nome || undefined,
        ...
        const total = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$Funcionario$2e$service$2f$funcionario$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["contarFuncionarios"])({
            nome: nome || undefined,
            status: status || undefined,
            funcao: funcao || undefined,
            centros: filtroCentros
...
async function POST(request) {
    ...
    if (!canAccess || !canCreate) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        message: 'Sem permissao para criar funcionario'
    }, {
        status: 403
    });
    try {
        ...
        const licencasVinculos = Array.isArray(dados.licencasVinculos) ? dados.licencasVinculos.map((v)=>({
                idLic: v.idLic,
        ...
        const funcionario = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$Funcionario$2e$service$2f$funcionario$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["criarFuncionario"])({
            idMatFun: dados.idMatFun,
            nomeFun: dados.nomeFun,
            cpfFun: dados.cpfFun,
            dataAdmFun: (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$date$2d$input$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseOptionalDateInput"])(dados.dataAdmFun),
            avatarFun: dados.avatarFun,
            idFuncaoFun: dados.idFuncaoFun,
            idStatusFun: dados.idStatusFun,
            idCustoFun: dados.idCustoFun,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a1b1cf57._.js.map