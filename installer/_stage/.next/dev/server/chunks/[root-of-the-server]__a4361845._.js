...
"[project]/src/app/api/ccusto/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    const canAccess = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$access$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hasModuleAccessForRequest"])(request, 'CENTRO_CUSTO');
    if (!canAccess) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        message: 'Sem permissao para acessar centro de custo'
    }, {
        status: 403
    });
    try {
        ...
        const { centros, allowAll, formularios } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$access$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAccessContext"])(request);
        ...
        const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$CentroCusto$2e$service$2f$centrocusto$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listarCentrosCusto"])({
        ...
        const total = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$CentroCusto$2e$service$2f$centrocusto$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["contarCentrosCusto"])({
            descricao: descricao || undefined,
            codigo: codigo || undefined,
            ids: idsFiltro
        });
...
async function POST(request) {
    ...
    if (!canAccess || !canCreate) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        message: 'Sem permissao para criar centro de custo'
    }, {
        status: 403
    });
    try {
        ...
        const created = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$CentroCusto$2e$service$2f$centrocusto$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["criarCentroCusto"])({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a4361845._.js.map