...
"[project]/src/app/api/unifi-config/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    const canAccess = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$access$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["hasModuleAccessForRequest"])(request, 'UNIFI_CONFIG');
    ...
    if (all === 'true') {
        try {
            const configs = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$unifi$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAllUnifiConfigs"])();
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Erro ao recuperar configuracoes'
            }, {
                status: 500
            });
        }
    ...
    try {
        const config = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$unifi$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getUnifiConfig"])();
        if (!config) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            config: null
        });
        const safeConfig = {
            id: config.id,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Erro ao recuperar configuracao'
        }, {
            status: 500
        });
    }
...
async function POST(request) {
    ...
    if (!canAccess || !canCreate) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: 'Sem permissao para salvar configuracao'
    }, {
        status: 403
    });
    try {
        ...
        if (!type) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Tipo de API e necessario'
            }, {
                status: 400
            });
        }
        const config = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$unifi$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["saveUnifiConfig"])({
            type,
...
async function DELETE(request) {
    ...
    if (!canAccess || !canDelete) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: 'Sem permissao para deletar'
    }, {
        status: 403
    });
    const searchParams = request.nextUrl.searchParams;
    ...
    if (id) {
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$unifi$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deactivateUnifiConfig"])(id);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: 'Configuracao desativada com sucesso'
            });
        } catch (error) {
            console.error('Erro ao desativar configuracao:', error);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Erro ao desativar configuracao'
            }, {
                status: 500
            });
        }
    ...
    try {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Erro ao deletar configuracao'
        }, {
            status: 500
        });
    }
...
async function PATCH(request) {
    ...
    if (!canAccess || !canUpdate) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        error: 'Sem permissao para ativar configuracao'
    }, {
        status: 403
    });
    try {
        ...
        if (!id) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'ID e necessario para ativar configuracao'
            }, {
                status: 400
            });
        }
        const config = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$service$2f$unifi$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["activateUnifiConfig"])(id);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            config,
            message: 'Configuracao ativa atualizada com sucesso'
        });
    } catch (error) {
        console.error('Erro ao ativar configuracao:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Erro ao ativar configuracao'
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__7079c8ba._.js.map