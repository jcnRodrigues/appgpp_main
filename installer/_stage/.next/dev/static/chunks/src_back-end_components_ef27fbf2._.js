...
"[project]/src/back-end/components/PatrimonioTable/ListaPatrimoniosPdfReport.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "gerarListaPatrimoniosPdf",
    ()=>gerarListaPatrimoniosPdf
]);
...
function gerarListaPatrimoniosPdf(selecionados) {
    ...
    const addTableRow = (cells, widths)=>{
        pdf.setFont('helvetica', 'normal');
        pdf.setFontSize(7.3);
    ...
    const emissaoCode = `DEV${dataToken}-${String(contador).padStart(3, '0')}`;
    pdf.setFont('helvetica', 'bold');
    pdf.setFontSize(15);
    ...
    pdf.setFontSize(9);
    pdf.setTextColor(86, 98, 114);
    pdf.text(pdfSafeText(`Data/Hora: ${agora.toLocaleString('pt-BR', {
        timeZone: 'America/Sao_Paulo'
    })}`), margin, y);
    y += 5;
    ...
    const cardTop = y + 2;
    drawCard(margin, cardTop, cW, 18, 'Total de itens', String(selecionados.length), formatarMoeda(totalValor), [
        35,
        43,
        54
    ]);
    drawCard(margin + cW + gap, cardTop, cW, 18, 'Status ativo', String(totalAtivos), '-', [
        15,
        125,
        67
    ]);
    drawCard(margin + (cW + gap) * 2, cardTop, cW, 18, 'Com data de saida', String(totalComSaida), '-', [
        64,
        83,
        111
    ]);
    drawCard(margin + (cW + gap) * 3, cardTop, cW, 18, 'Sem data de saida', String(selecionados.length - totalComSaida), '-', [
        185,
        83,
        0
    ]);
...
"[project]/src/back-end/components/PatrimonioTable/ListaPatrimoniosPdfForm.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/back-end/components/ui/button.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$components$2f$PatrimonioTable$2f$ListaPatrimoniosPdfReport$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/back-end/components/PatrimonioTable/ListaPatrimoniosPdfReport.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
;
...
function ListaPatrimoniosPdfForm() {
    _s();
    ...
    const [resultados, setResultados] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    const [centroId, setCentroId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('');
    const [mostrarSaida, setMostrarSaida] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [dataSaidaLote, setDataSaidaLote] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(new Date().toISOString().split('T')[0]);
    const [salvandoSaida, setSalvandoSaida] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const idsSelecionados = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ListaPatrimoniosPdfForm.useMemo[idsSelecionados]": ()=>new Set(selecionados.map({
                "ListaPatrimoniosPdfForm.useMemo[idsSelecionados]": (x)=>x.idP
            }["ListaPatrimoniosPdfForm.useMemo[idsSelecionados]"]))
    }["ListaPatrimoniosPdfForm.useMemo[idsSelecionados]"], [
        selecionados
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ListaPatrimoniosPdfForm.useEffect": ()=>{
            const carregarCentros = {
                "ListaPatrimoniosPdfForm.useEffect.carregarCentros": async ()=>{
                    try {
            ...
            }["ListaPatrimoniosPdfForm.useEffect.carregarCentros"];
    ...
    const aplicarDataSaidaSelecionados = async ()=>{
        ...
        try {
            const resultadosAtualizacao = await Promise.allSettled(itensValidos.map((item)=>fetch(`/api/patrimonio/${item.idP}`, {
                    method: 'PUT',
                    headers: {
                        'Content-Type': 'application/json'
                    },
                    body: JSON.stringify({
                        dataSaiPat: dataSaidaLote
                    })
                })));
            ...
            if (sucessoIds.size > 0) {
                setSelecionados((prev)=>prev.map((item)=>sucessoIds.has(item.idP) ? {
                            ...item,
                            dataSaiPat: dataSaidaLote
                        } : item));
                setResultados((prev)=>prev.map((item)=>sucessoIds.has(item.idP) ? {
                            ...item,
                            dataSaiPat: dataSaidaLote
                        } : item));
            }
    ...
    const gerarPdf = ()=>{
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$components$2f$PatrimonioTable$2f$ListaPatrimoniosPdfReport$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["gerarListaPatrimoniosPdf"])(selecionados);
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "space-y-4",
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                        ...
                        children: "Pesquisar Patrimônios"
                    }, void 0, false, {
                        fileName: "[project]/src/back-end/components/PatrimonioTable/ListaPatrimoniosPdfForm.tsx",
                        lineNumber: 179,
                        columnNumber: 9
                    }, this),
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                    children: [
                                        resultados.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                className: "border-b",
                                                children: [
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                    ...
                                                                    children: item.tbCCusto?.descricaoCCusto || 'Sem centro de custo'
                                                                }, void 0, false, {
                                                                    fileName: "[project]/src/back-end/components/PatrimonioTable/ListaPatrimoniosPdfForm.tsx",
                                                                    lineNumber: 228,
                                                                    columnNumber: 23
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        className: "px-2 py-2",
                                                        children: item.tbTipoPat?.descricaoTipPat || '-'
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/back-end/components/PatrimonioTable/ListaPatrimoniosPdfForm.tsx",
                                                        lineNumber: 233,
                                                        columnNumber: 19
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        className: "px-2 py-2",
                                                        children: formatarMoeda(item.valorPat)
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/back-end/components/PatrimonioTable/ListaPatrimoniosPdfForm.tsx",
                                                        lineNumber: 234,
                                                        columnNumber: 19
                      ...
                      ${getStatusBadgeClass(item.tbStatusPat?.descricaoStatPat)}`,
                                                            children: item.tbStatusPat?.descricaoStatPat || 'SEM STATUS'
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/back-end/components/PatrimonioTable/ListaPatrimoniosPdfForm.tsx",
                                                            lineNumber: 236,
                                                            columnNumber: 21
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        className: "px-2 py-2",
                                                        children: idsSelecionados.has(item.idP) ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                                            type: "button",
                                                            size: "icon",
                                                            variant: "outline",
                                        ...
                                        resultados.length === 0 && !loading && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    ...
                    mostrarSaida && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "border rounded-lg p-3 flex flex-col md:flex-row md:items-end gap-3",
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                        className: "block text-sm font-medium mb-1",
                                        children: "Data de saída"
                                    }, void 0, false, {
                                        fileName: "[project]/src/back-end/components/PatrimonioTable/ListaPatrimoniosPdfForm.tsx",
                                        lineNumber: 301,
                                        columnNumber: 15
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                ...
                                children: salvandoSaida ? 'Salvando...' : 'Salvar na Base'
                            }, void 0, false, {
                                fileName: "[project]/src/back-end/components/PatrimonioTable/ListaPatrimoniosPdfForm.tsx",
                                lineNumber: 309,
                                columnNumber: 13
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                    children: [
                                        selecionados.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                className: "border-b",
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        className: "px-2 py-2",
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        className: "px-2 py-2",
                                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            className: `inline-block rounded-full px-2 py-0.5 text-[10px] font-semibold ${getStatusBadgeClass(item.tbStatusPat?.descricaoStatPat)}`,
                                                            children: item.tbStatusPat?.descricaoStatPat || 'SEM STATUS'
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/back-end/components/PatrimonioTable/ListaPatrimoniosPdfForm.tsx",
                                                            lineNumber: 348,
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        className: "px-2 py-2",
                                                        children: formatarData(item.dataEntPat)
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/back-end/components/PatrimonioTable/ListaPatrimoniosPdfForm.tsx",
                                                        lineNumber: 352,
                                                        columnNumber: 19
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                        className: "px-2 py-2",
                                                        children: formatarData(item.dataSaiPat || null)
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/back-end/components/PatrimonioTable/ListaPatrimoniosPdfForm.tsx",
                                                        lineNumber: 353,
                                                        columnNumber: 19
                                        ...
                                        selecionados.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                colSpan: 8,
                                                className: "px-2 py-3 text-gray-500",
                                                children: "Nenhum patrimônio selecionado."
                                            }, void 0, false, {
                                                fileName: "[project]/src/back-end/components/PatrimonioTable/ListaPatrimoniosPdfForm.tsx",
                                                lineNumber: 370,
                                                columnNumber: 19
...
_s(ListaPatrimoniosPdfForm, "s28wf71IuK6DXuVVicAlf90xSW4=");
_c = ListaPatrimoniosPdfForm;
var _c;
__turbopack_context__.k.register(_c, "ListaPatrimoniosPdfForm");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_back-end_components_ef27fbf2._.js.map