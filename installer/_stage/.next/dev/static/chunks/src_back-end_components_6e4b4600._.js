...
function DeleteGuardButton({ resource, recordId, onAuthorizedDelete, className, title = 'Excluir', children }) {
    ...
    const canDeleteAny = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "DeleteGuardButton.useMemo[canDeleteAny]": ()=>{
...
_s(DeleteGuardButton, "wegZx1K2QAdIeE/PVTHhJY9/2Jw=", false, function() {
    return [
...
_s(CadastroTable, "LlBJ6cgmL+1oTKojTfkiWuWNgks=");
_c = CadastroTable;
var _c;
...
//# sourceMappingURL=src_back-end_components_6e4b4600._.js.map