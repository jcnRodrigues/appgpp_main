...
"[project]/src/back-end/components/Dashboard/refreshConfig.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/src/back-end/components/Dashboard/DashboardCards.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$components$2f$Dashboard$2f$refreshConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/back-end/components/Dashboard/refreshConfig.ts [app-client] (ecmascript)");
;
...
function DashboardCards({ totalPatrimonios, totalFuncionarios }) {
    _s();
    const [resumo, setResumo] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        totalPatrimonios,
        totalFuncionarios
    });
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DashboardCards.useEffect": ()=>{
            const refreshMs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$components$2f$Dashboard$2f$refreshConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDashboardRefreshMs"])();
            const carregarResumo = {
                "DashboardCards.useEffect.carregarResumo": async ()=>{
                    try {
            ...
            }["DashboardCards.useEffect.carregarResumo"];
            carregarResumo();
            if (refreshMs <= 0) return;
            const timer = setInterval({
                "DashboardCards.useEffect.timer": ()=>{
                    carregarResumo();
                }
            }["DashboardCards.useEffect.timer"], refreshMs);
            return ({
                "DashboardCards.useEffect": ()=>clearInterval(timer)
            })["DashboardCards.useEffect"];
        }
    }["DashboardCards.useEffect"], []);
...
_s(DashboardCards, "JcPnfzP/RYe7CoMmV8x9h42YuLw=");
_c = DashboardCards;
var _c;
...
"[project]/src/back-end/components/Dashboard/GraficoAlocacoesPorCentro.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function GraficoAlocacoesPorCentro() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GraficoAlocacoesPorCentro.useEffect": ()=>{
            const refreshMs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$components$2f$Dashboard$2f$refreshConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDashboardRefreshMs"])();
            const carregarDados = {
                "GraficoAlocacoesPorCentro.useEffect.carregarDados": async ()=>{
                    try {
            ...
            }["GraficoAlocacoesPorCentro.useEffect.carregarDados"];
            carregarDados();
            if (refreshMs <= 0) return;
            const timer = setInterval({
                "GraficoAlocacoesPorCentro.useEffect.timer": ()=>{
                    carregarDados();
                }
            }["GraficoAlocacoesPorCentro.useEffect.timer"], refreshMs);
            return ({
                "GraficoAlocacoesPorCentro.useEffect": ()=>clearInterval(timer)
            })["GraficoAlocacoesPorCentro.useEffect"];
        }
    }["GraficoAlocacoesPorCentro.useEffect"], []);
    if (loading) {
...
_s(GraficoAlocacoesPorCentro, "XqjjVLOYn2sJeiFCD3em9MKGMSg=");
_c = GraficoAlocacoesPorCentro;
var _c;
__turbopack_context__.k.register(_c, "GraficoAlocacoesPorCentro");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/back-end/components/Dashboard/GraficoAlocacoesLinha.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function GraficoAlocacoesLinha() {
    ...
    const [loading, setLoading] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "GraficoAlocacoesLinha.useEffect": ()=>{
            const refreshMs = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$components$2f$Dashboard$2f$refreshConfig$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getDashboardRefreshMs"])();
            const carregarDados = {
                "GraficoAlocacoesLinha.useEffect.carregarDados": async ()=>{
                    try {
            ...
            }["GraficoAlocacoesLinha.useEffect.carregarDados"];
            carregarDados();
            if (refreshMs <= 0) return;
            const timer = setInterval({
                "GraficoAlocacoesLinha.useEffect.timer": ()=>{
                    carregarDados();
                }
            }["GraficoAlocacoesLinha.useEffect.timer"], refreshMs);
            return ({
                "GraficoAlocacoesLinha.useEffect": ()=>clearInterval(timer)
            })["GraficoAlocacoesLinha.useEffect"];
        }
    }["GraficoAlocacoesLinha.useEffect"], []);
    if (loading) {
...
_s(GraficoAlocacoesLinha, "TWbk09vkKkZyOIDtCRiaSk6Xrwo=");
_c = GraficoAlocacoesLinha;
var _c;
__turbopack_context__.k.register(_c, "GraficoAlocacoesLinha");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_9a2353f3._.js.map