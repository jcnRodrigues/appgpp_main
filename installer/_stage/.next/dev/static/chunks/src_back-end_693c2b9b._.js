...
"[project]/src/back-end/components/LicencaForm/LicencaForm.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function LicencaForm({ licencaId }) {
    ...
    const initialLicenca = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "LicencaForm.useMemo[initialLicenca]": ()=>({
                descricaoLic: ''
            })
    }["LicencaForm.useMemo[initialLicenca]"], []);
    const { state: licenca, setState: setLicenca, clearDraft: clearLicencaDraft } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$hooks$2f$useFormDraft$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFormDraft"])('licenca-form-create', initialLicenca, {
        enabled: !licencaId
    });
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "LicencaForm.useEffect": ()=>{
            const carregarDados = {
                "LicencaForm.useEffect.carregarDados": async ()=>{
                    if (licencaId) {
                        try {
            ...
            }["LicencaForm.useEffect.carregarDados"];
            carregarDados();
        }
    }["LicencaForm.useEffect"], [
        licencaId,
...
_s(LicencaForm, "MRsgZOwqccFo65w30ksy9r3t+RE=", false, function() {
    return [
...
_c = LicencaForm;
var _c;
__turbopack_context__.k.register(_c, "LicencaForm");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_back-end_693c2b9b._.js.map