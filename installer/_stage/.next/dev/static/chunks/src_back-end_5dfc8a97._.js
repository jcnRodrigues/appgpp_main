...
"[project]/src/back-end/components/FuncaoForm/FuncaoForm.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function FuncaoForm({ funcaoId }) {
    ...
    const initialFuncao = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "FuncaoForm.useMemo[initialFuncao]": ()=>({
                nomeFuncao: ''
            })
    }["FuncaoForm.useMemo[initialFuncao]"], []);
    const { state: funcao, setState: setFuncao, clearDraft: clearFuncaoDraft } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$back$2d$end$2f$hooks$2f$useFormDraft$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useFormDraft"])('funcao-form-create', initialFuncao, {
        enabled: !funcaoId
    });
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FuncaoForm.useEffect": ()=>{
            if (funcaoId) {
                const carregar = {
                    "FuncaoForm.useEffect.carregar": async ()=>{
                        try {
...
_s(FuncaoForm, "8jp218AePbNa/iVrniawH5mi1xs=", false, function() {
    return [
...
_c = FuncaoForm;
var _c;
__turbopack_context__.k.register(_c, "FuncaoForm");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_back-end_5dfc8a97._.js.map