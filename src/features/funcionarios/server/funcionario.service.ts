...
export async function getFuncionariosFuncaoById(id: string) {
...
export async function getFuncionariosStatusById(id: string, descricao?: string) {
...
export async function getFuncionariosById(id: string) {
...
export async function getStatusFuncionarios() {
...
export async function getLicencasDisponiveisParaFuncionarios() {
...
export async function getFuncionariosByIdInterno(idF: string) {
    return await prisma.tbFuncionario.findUnique({
        where: { idF },
        include: {
            tbFuncao: true,
