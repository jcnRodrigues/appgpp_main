...
import { ClipboardCheck, DatabaseBackup, Home, KeyRound, LandmarkIcon, LaptopIcon, LogOut, Menu, Monitor, Moon, PackagePlusIcon, Router, Settings, Sun, User, UserSearchIcon, UserCog } from "lucide-react";
...
export default function Header() {
    ...
    useEffect(() => {
        // Mantem o menu condicionado ao cliente para evitar mismatch de hidratacao.
        ...
        shadow  text-[#0f5132] font-bold text-lg tracking-tight">
                    <Link href={"/"}>
                        <Image
                            ...
                            priority
                            loading="eager"
                            className="rounded-sm h-20 sm:h-24 md:h-28 lg:h-32 w-auto"
                            style={{ width: 'auto' }}
                            title="Gestão de Patrimonio Privado"
                        />
                    </Link>
                </span>
            </h1>
                                    ...
                                    <SheetHeader className="shrink-0 border-b border-border px-4 py-4">
                                        <SheetTitle className="text-primary text-center">
                                            <Image
                                                ...
                                                width={50}
                                                height={50}
                                                className="rounded-sm h-12 w-auto"
                                                style={{ width: 'auto' }}
                                                title="Gestão de Patrimonio Privado"
                                            />Menu
                                        </SheetTitle>
                                        <SheetDescription className="text-center text-muted-foreground">
                                            Bem-vindo ao Gestão de Patrimonio Privado! Gerencie seus recursos de forma eficiente e simplificada.
                                        </SheetDescription>
                                    </SheetHeader>
                                            ...
                                            <>
                                                <div className="flex items-center gap-4 mt-6 border-b border-border pb-6">
                                                    ...
                                                    <div className="flex flex-col">
                                                        <span className="font-bold text-foreground">Bem-vindo, {session.user?.name}</span>
