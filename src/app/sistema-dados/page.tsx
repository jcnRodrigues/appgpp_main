...
const TABLE_HEADERS: Record<(typeof TABLE_NAMES)[number], string[]> = {
    ...
    tbFornecedor: ["idFornecedor", "razaoSocialFornecedor", "nomeFantasiaFornecedor", "cnpjFornecedor", "createdAt", "updatedAt"],
    tbFornecedorCCusto: ["idFornecedorCCusto", "idFornecedor", "idCCusto", "ehPrincipal", "idFornecedor_descricao", "idCCusto_descricao", "createdAt", "updatedAt"],
