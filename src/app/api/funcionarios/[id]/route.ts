...
import { getFuncionariosByIdInterno, atualizarFuncionario } from '@/features/funcionarios/server/funcionario.service';
...
export async function GET(
    ...
    try {
        ...
        const funcionario = await getFuncionariosByIdInterno(id);
