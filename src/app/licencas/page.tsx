            ...
            <div className="max-w-[86.4rem] mx-auto px-4">
                <div className="form-title-sticky flex items-center justify-between mb-8 mt-4">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-h2 font-bold">Licencas de Software</h1>
                            <p className="text-gray-600 text-sm mt-1">Lista de licencas vinculadas aos funcionarios</p>
                        </div>
                    </div>
                    <Link href="/licenca/cadastro">
